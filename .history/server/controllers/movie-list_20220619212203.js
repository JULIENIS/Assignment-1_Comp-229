...
function DisplayMovieListPage(req, res, next) {
    movie_1.default.find(function (err, moviesCollection) {
        ...
        res.render('index', { title: 'Client List', page: 'movie-list', movies: moviesCollection, displayName: (0, Util_1.UserDisplayName)(req) });
    });
}
...
function ProcessAddPage(req, res, next) {
    let newMovie = new movie_1.default({
        ...
        "Company": req.body.movieDirector,
        "Phone": req.body.movieYear,
        "Email": req.body.movieRating
    });
